	...
	var Form = React.createClass({displayName: "Form",
		...
		render: function () {
			return (
				  ...
				  React.createElement("div", {className: this.state.tipType}, 
						this.state.tip
				  ), 
				  React.createElement("div", null, 
						React.createElement(Validator, {type: "account", onError: this.errorAccount}), 
						React.createElement(Validator, {type: "password", onError: this.errorPassword})
				  )
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Validator = React.createClass({displayName: "Validator",
		getInitialState: function () {
			var name,type;
		...
		render: function () {
			return (
			  React.createElement("div", null, 
				  ...
				  React.createElement("input", {onChange: this.state.check})
			  )
			);
		}
	});
